                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <x-input type="text" name="name" id="name" label="Emri i Qytetit"
                                        placeholder="Ju lutem shkruani emrin" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                                        value="{{ old('name') }}"> 
                                    </x-input>
                                    @if ($errors->has('name'))
